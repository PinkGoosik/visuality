...
public class Buildscript extends SimpleFabricProject {
	...
	public void getModDependencies(ModDependencyCollector d) {
		...
		d.addMaven("https://pkgs.dev.azure.com/djtheredstoner/DevAuth/_packaging/public/maven/v1", new MavenId("me.djtheredstoner", "DevAuth-fabric", "1.0.0"), ModDependencyFlag.RUNTIME);
	}
